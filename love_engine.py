...
WARM_GIFTS = {
    'warm_cup': {
        'id': 'warm_cup',
        'name': {'zh': '暖手茶杯', 'en': 'Warm Tea Cup', 'ja': '温かいティーカップ'},
        'icon': '☕',
        'price': 30,
        'affection': 8,
        'tier': 'warm',
        ...
        'is_popular': False,
        'reaction': {
            'zh': '「捧着它好温暖～像你牵着我手的感觉，谢谢你送的小确幸」',
            'en': "「Holding it feels so warm~ Like your hand in mine, thank you for this little happiness」",
            'ja': '「持つと温かい～あなたと手を繋いでいるみたい。小さな幸せをありがとう」'
        }
    },
    'bookmark': {
        'id': 'bookmark',
        'name': {'zh': '花语书签', 'en': 'Floral Bookmark', 'ja': '花言葉のしおり'},
        'icon': '🌸',
        'price': 38,
        'affection': 10,
        'tier': 'warm',
        ...
        'is_popular': False,
        'reaction': {
            'zh': '「每片花瓣都写着想对你说的话…翻开书就能想起我哦」',
            'en': "「Each petal carries words I want to tell you... Remember me when you open your book」",
            'ja': '「花びら一枚一枚にあなたへの言葉を…本を開くたびに思い出してね」'
        }
    },
    'sweet_journal': {
        'id': 'sweet_journal',
        'name': {'zh': '甜蜜手账', 'en': 'Sweet Journal', 'ja': 'スイートジャーナル'},
        'icon': '📓',
        'price': 48,
        'affection': 12,
        'tier': 'warm',
        ...
        'is_popular': False,
        'reaction': {
            'zh': '「要把我们的点点滴滴都记下来～以后一起笑着翻阅」',
            'en': "「I will write down every little moment between us~ We can smile looking back later」",
            'ja': '「二人の細かい思い出を全部書き留めて～いつか一緒に笑いながら見返そう」'
        }
    },
    'star_bracelet': {
        'id': 'star_bracelet',
        'name': {'zh': '星光手链', 'en': 'Starlight Bracelet', 'ja': '星のブレスレット'},
        'icon': '✨',
        'price': 58,
        'affection': 14,
        'tier': 'warm',
        ...
        'is_popular': False,
        'reaction': {
            'zh': '「星光在腕间流转，像你眼中的温柔～我会一直戴着它」',
            'en': "「Starlight flows around your wrist, like the gentleness in your eyes~ I will wear it forever」",
            'ja': '「星の光が手首にきらめく、あなたの瞳の優しさみたい～ずっと身に着けるね」'
        }
    },
}
...
GIFT_TIERS = {
    ...
    'warm': {
        'name': {'zh': '温馨心意', 'en': 'Warm Heart', 'ja': '温かい気持ち'},
        'desc': {'zh': '温暖互动、贴心陪伴、增进默契', 'en': 'Warm interaction, caring company, deepen connection', 'ja': '温かい交流、気配りの伴侶、絆を深める'},
        'icon': '🌟',
        'price_range': '30-58'
    },
    'deep': {

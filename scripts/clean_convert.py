#!/usr/bin/env python3
"""Clean batch converter - uses _() everywhere with no conditionals."""
import os

TDIR = '/tmp/soullink/templates'

REPLACEMENTS = [
    ('index.html', '三大温暖体验', "{{ _('warm_experiences') }}"),
    ...
    ('story-chain.html', '故事接龙', "{{ _('story_chain') }}"),
    ...
    ('agent_profile.html', '专长领域', "{{ _('specialty') }}"),
